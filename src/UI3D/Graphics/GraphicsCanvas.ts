...
export class GraphicsCanvas extends GraphicsEventBus {
	...
	public getOverlayContainer = ()  => this._overlayContainer;
	public getOverlayCanvas = () => this._overlayCanvas;
